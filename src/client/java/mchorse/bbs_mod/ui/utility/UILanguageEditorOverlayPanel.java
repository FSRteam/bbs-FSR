...
public class UILanguageEditorOverlayPanel extends UIOverlayPanel
{
    ...
    public UILanguageEditorOverlayPanel()
    {
        ...
        this.completion.background(Colors.A50 | BBSSettings.accentColorRGB()).labelAnchor(1F, 0.55F);
    ...
    private void changeReference()
    {
        ...
        UILabelOverlayPanel<String> panel = new UILabelOverlayPanel<>(UIKeys.LANGUAGE_EDITOR_REFERENCE_TITLE, labels, (str) ->
        {
    ...
    private void renderMissingBackground(UIContext context)
    {
        if (this.viewMissing)
        {
            this.missing.area.render(context.batcher, Colors.A50 | BBSSettings.accentColorRGB(), 1);
        }
    }
