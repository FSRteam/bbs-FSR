...
public class UIParticleSchemeExpireInBlocksSection extends UIParticleSchemeComponentSection<ParticleComponentExpireInBlocks>
{
    private UIElement blockListContainer;
    private List<UIItemStack> blockItems = new ArrayList<>();
    private UIElement addBlockButton;

    public UIParticleSchemeExpireInBlocksSection(UIParticleSchemePanel parent)
    {
        super(parent);
    ...
    {
        return UIKeys.SNOWSTORM_EXPIRATION_IN_BLOCKS;
    }

    @Override
    protected ParticleComponentExpireInBlocks getComponent(ParticleScheme scheme)
    {
        return scheme.getOrCreate(ParticleComponentExpireInBlocks.class);
    }
