...
public class TimelineRulerRenderer
{
    ...
    public static void render(UIContext context, Area area, int startTick, int durationTick, IntUnaryOperator toGraphX, IntFunction<String> labelFormatter)
    {
        render(context, area, startTick, durationTick, toGraphX, labelFormatter, null);
    }

    public static void render(UIContext context, Area area, int startTick, int durationTick, IntUnaryOperator toGraphX, IntFunction<String> labelFormatter, Consumer<UIContext> rulerDecorator)
    {
    ...
    private static void renderTicks(UIContext context, Area area, int startTick, int timelineBottom, int visibleEx, IntUnaryOperator toGraphX, IntFunction<String> labelFormatter)
    {
    ...
    public static void renderGrid(UIContext context, Area area, int top, int startTick, int durationTick, IntUnaryOperator toGraphX, IntFunction<String> labelFormatter)
    {
        double pxPerTick = pixelsPerTick(toGraphX);
        ...
        context.batcher.clip(area.x, top, area.w, area.ey() - top, context);
