...
public class UIPixelsEditor extends UICanvasEditor
{
    ...
    private void renderSelection(UIContext context)
    {
        ...
        ShaderInstance shader = BBSShaders.getSelectionProgram();
        ...
        Uniform phase = shader.getUniform("Phase");
        ...
        Uniform scale = shader.getUniform("Scale");
    ...
    public void setDocument(Document document)
    {
        ...
        else if (this.temporaryFlat != null)
        {
            this.temporaryFlat.delete();
            this.temporaryFlat = null;
        }
