...
public enum CameraFacing
{
    ...
    LOOKAT_XYZ("lookat_xyz"), LOOKAT_Y("lookat_y"), LOOKAT_DIRECTION("lookat_direction"),
    DIRECTION_X("direction_x"), DIRECTION_Y("direction_y"), DIRECTION_Z("direction_z"),
    EMITTER_TRANSFORM_XY("emitter_transform_xy"), EMITTER_TRANSFORM_XZ("emitter_transform_xz"), EMITTER_TRANSFORM_YZ("emitter_transform_yz");
