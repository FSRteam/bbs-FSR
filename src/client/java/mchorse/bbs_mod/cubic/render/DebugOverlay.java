...
/** Shared geometry primitives for configurable IK and physics debug overlays. */
public final class DebugOverlay
{
    ...
    {
        vertex(builder, matrix, p1, col, a);
        vertex(builder, matrix, p2, col, a);
        vertex(builder, matrix, p3, col, a);
        vertex(builder, matrix, p1, col, a);
        vertex(builder, matrix, p3, col, a);
        vertex(builder, matrix, p4, col, a);
    }

    private static void vertex(BufferBuilder builder, Matrix4f matrix, Vector3f p, float[] col, float a)
    {
        builder.addVertex(matrix, p.x, p.y, p.z).setColor(col[0], col[1], col[2], a);
    }
