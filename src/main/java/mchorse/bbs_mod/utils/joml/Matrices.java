...
public class Matrices
{
    ...
    public static Matrix3f direction(Vector3f forward, Matrix3f direction, Vector3f right, Vector3f up)
    {
        ...
        right.cross(forward);
        up.cross(right);
        direction.m00 = right.x; direction.m01 = right.y; direction.m02 = right.z;
        direction.m10 = forward.x; direction.m11 = forward.y; direction.m12 = forward.z;
        direction.m20 = up.x; direction.m21 = up.y; direction.m22 = up.z;
    ...
    /** Compatibility overload retained for allocation-managed solver workspaces. */
    public static Vector3f toEulerZYXDegrees(Quaternionf q, Vector3f out, Quaternionf scratch)
    {
        return toEulerZYXRadians(q, out).mul((float) (180.0 / Math.PI));
    }
    ...
    public static Quaternionf orientMirroredX(Vector3f restDir, Vector3f restNormal, Vector3f toDir, Vector3f toNormal, Quaternionf out, Matrix3f rest, Matrix3f to, Matrix3f rotation, Vector3f u, Vector3f v, Vector3f w)
    {
        ...
        rotation.m01 = -rotation.m01; rotation.m02 = -rotation.m02;
        rotation.m10 = -rotation.m10; rotation.m20 = -rotation.m20;
    ...
    public static Quaternionf twistAbout(Quaternionf q, Vector3f axis, Quaternionf out)
    {
        ...
        return out.lengthSquared() < 1.0e-12f ? out.identity() : out.normalize();
    }
}
