...
public class MCEntity implements IEntity
{
    ...
    {
        return this.mcEntity.xOld;
    }

    @Override
    public void setPrevX(double x)
    {
        this.mcEntity.xOld = x;
    }
    ...
    {
        return this.mcEntity.yOld;
    }

    @Override
    public void setPrevY(double y)
    {
        this.mcEntity.yOld = y;
    }
    ...
    {
        return this.mcEntity.zOld;
    }

    @Override
    public void setPrevZ(double z)
    {
        this.mcEntity.zOld = z;
    }
    ...
    public float getHeadYaw()
    {
        ...
        return this.mcEntity.getYHeadRot();
    }
