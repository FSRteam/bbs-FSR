...
public class Icons
{
    ...
    public static final Link PARTICLE_ATLAS = Link.assets("textures/default_particles.png");

    public static final Icon PARTICLE_TAB_QUICK_SETUP = register(new Icon(PARTICLE_ATLAS, "particle_tab_quick_setup", 0, 0, 16, 16, 128, 128));
    public static final Icon PARTICLE_TAB_FILE = register(new Icon(PARTICLE_ATLAS, "particle_tab_file", 16, 0, 16, 16, 128, 128));
    public static final Icon PARTICLE_TAB_EMITTER = register(new Icon(PARTICLE_ATLAS, "particle_tab_emitter", 32, 0, 16, 16, 128, 128));
    public static final Icon PARTICLE_TAB_MOTION = register(new Icon(PARTICLE_ATLAS, "particle_tab_motion", 48, 0, 16, 16, 128, 128));
    public static final Icon PARTICLE_TAB_APPEARANCE = register(new Icon(PARTICLE_ATLAS, "particle_tab_appearance", 64, 0, 16, 16, 128, 128));
    public static final Icon PARTICLE_TAB_TIME = register(new Icon(PARTICLE_ATLAS, "particle_tab_time", 80, 0, 16, 16, 128, 128));
    public static final Icon PARTICLE_TAB_EVENTS = register(new Icon(PARTICLE_ATLAS, "particle_tab_events", 96, 0, 16, 16, 128, 128));
    public static final Icon PARTICLE_TAB_CURVES = register(new Icon(PARTICLE_ATLAS, "particle_tab_curves", 112, 0, 16, 16, 128, 128));
