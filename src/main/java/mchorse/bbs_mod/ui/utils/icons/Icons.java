...
public class Icons
{
    ...
    public static final Icon PARTICLE_TAB_QUICK_SETUP = register(new Icon(ATLAS, "particle_tab_quick_setup", 96, 160));
    public static final Icon PARTICLE_TAB_FILE = register(new Icon(ATLAS, "particle_tab_file", 48, 80));
    public static final Icon PARTICLE_TAB_EMITTER = register(new Icon(ATLAS, "particle_tab_emitter", 80, 160));
    public static final Icon PARTICLE_TAB_MOTION = register(new Icon(ATLAS, "particle_tab_motion", 112, 112));
    public static final Icon PARTICLE_TAB_APPEARANCE = register(new Icon(ATLAS, "particle_tab_appearance", 16, 96));
    public static final Icon PARTICLE_TAB_TIME = register(new Icon(ATLAS, "particle_tab_time", 144, 16));
    public static final Icon PARTICLE_TAB_EVENTS = register(new Icon(ATLAS, "particle_tab_events", 144, 64));
    public static final Icon PARTICLE_TAB_CURVES = register(new Icon(ATLAS, "particle_tab_curves", 32, 240));
