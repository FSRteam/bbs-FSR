...
public class Icons
{
    ...
    public static final Icon PARTICLE_TAB_APPEARANCE = register(new Icon(ATLAS, "particle_tab_appearance", 96, 16));
    public static final Icon PARTICLE_TAB_TIME = register(new Icon(ATLAS, "particle_tab_time", 16, 144));
    public static final Icon PARTICLE_TAB_EVENTS = register(new Icon(ATLAS, "particle_tab_events", 64, 144));
    public static final Icon PARTICLE_TAB_CURVES = register(new Icon(ATLAS, "particle_tab_curves", 240, 32));
